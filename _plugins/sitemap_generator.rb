...
module Jekyll
  ...
  MY_URL = "http://willmendesneto.github.io"
  ...
  PAGES_INCLUDE_POSTS = ["index.html","/fr/index.html","archive.html"]
  ...
  class Page
    ...
    def location_on_server
      # @nicoespeon : Personal modification not to include the directory
